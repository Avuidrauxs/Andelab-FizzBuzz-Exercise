...
describe("Fizz Buzz tests ", function() {
  ...
  //Included my own tests
    it("should return 'Fizz' for 69", function() {
    expect(myApp.fizzBuzz(69)).toBe('Fizz');
  });

  it("should return 'Undefined' since its indivisible by 3 and 5", function() {
    expect(myApp.fizzBuzz(0)).toBe("Undefined");
  });
